...
def homepage():
    ...
    st.markdown("---")
    st.subheader("Add comments to Snowflake objects")
    st.markdown("Streamlit's UI makes it easy for a user to execute simple, no-code SQL statements e.g. adding comments to an object")
